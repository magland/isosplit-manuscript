...
%The average is taken over all clusters (rather than datapoints) so that the larger or denser clusters do not %contribute with greater weight.
...
\begin{figure}
\begin{center}
\includegraphics[width=5.5in]{images/real_data_1.eps}
\end{center}
\caption{
...
\begin{figure}
\begin{center}
\includegraphics[width=5.5in]{images/real_data_2.eps}
\end{center}
\caption{
...
\begin{figure}
\begin{center}
\includegraphics[width=6in]{images/computation_times_01.eps}
\end{center}
\caption{
